...
export const debugPrefixCommand = new PrefixCommand({
    name: "debug",
    description: "Evaluate a statement of JavaScript code.",
});

debugPrefixCommand.setExecutable(async (message: Message, ...args: string[]) => {
